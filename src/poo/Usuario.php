...
class Usuario
{
    ...
    public function AgregarUno(Request $request, Response $response, array $args): Response
    {
        ...
        $obj_respuesta->mensaje = "El usuario no pudo ser agregado";
    ...
    public function TraerTodos(Request $request, Response $response, array $args): Response
    {
        $obj_respuesta = new stdClass();
        $obj_respuesta->exito = false;
        $obj_respuesta->mensaje = "No se encontraron usuarios existentes";
        $obj_respuesta->dato = "{}";
        ...
        if(count($usuarios)){
            $obj_respuesta->exito = true;
            $obj_respuesta->mensaje = "Usuarios encontrados correctamente";
    ...
    public function VerificarUsuario(Request $request, Response $response, array $args): Response
    {
        ...
        if (isset($arrayDeParametros["user"])) {
            ...
            if ($usuario = Usuario::TraerUsuario($obj)) {
                $data = array();
                unset($usuario->id);
                $alumno = array("nombre"=>"Barbara", "Apellido"=>"Barbara");
                $dni_alumno = array("dni_alumno"=>"11111111");
